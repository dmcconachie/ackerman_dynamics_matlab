...
stamp = '2019-10-10_09:08:00.753';
[obstacles, waypoints, waypoint_traj_indices, x_trajectory, u_trajectory, y_trajectory] = execute_path(car, ...
        append(basedir, '/problem_result__', stamp, '__obstacles.csv'), ...
        append(basedir, '/problem_result__', stamp, '__path.csv'), ...
        true);
%%
hold on
